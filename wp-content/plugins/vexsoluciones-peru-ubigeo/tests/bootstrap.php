<?php
/**
 * Vexsoluciones_Peru_Ubigeo Test Bootstrapper.
 *
 * @since   1.0
 ...
 * @since 1.0
 */
function _manually_load_vexsoluciones_peru_ubigeo_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/vexsoluciones-peru-ubigeo.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_vexsoluciones_peru_ubigeo_plugin' );
