...
/**
 * PagoEfectivo Gateway Pagoefectivo_crypto.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
class VGP_Pagoefectivo_Crypto extends VGP_Pagoefectivo_Service_Abstract {
    ...
    public function encrypt( $string ){
        $info = $this->_loadService( 'EncryptText', array(
            'plainText' => $string,
    ...
    public function decrypt( $string ){
        $info = $this->_loadService( 'DecryptText', array(
            'encryptText' => $string,
    ...
    public function signer( $string ){
        $info = $this->_loadService( 'Signer', array(
            'plainText'  => $string,
            'privateKey' => $this->getPrivateKey()
        ) );
    ...
    public function signerVal( $text, $signerText ){
        $info = $this->_loadService( 'SignerVal', array(
            'plainText' => $text,
    ...
    public function codifica( $string ){
        $info = $this->_loadService( 'BlackBox', array(
            'Cad' => $string
        ) );
