...
/**
 * PagoEfectivo Gateway Pagoefectivo_service_abstract.
 *
 * @since   1.0.0
 ...
 * @since 1.0.0
 */
abstract class VGP_Pagoefectivo_Service_Abstract {
    ...
    public function _loadService( $service, $data ){
        ...
        switch ( $service ) {
            case 'GenerarCIPMod1':
                $url = $this->_options[ 'url2' ];
                break;
            case 'ConsultarSolicitudPagov2':
                $url = $this->_options[ 'url2' ];
                break;
            case 'ActualizarCIPMod1':
                $url = $this->_options[ 'url2' ];
                break;
            case 'ConsultarCIPMod1':
                $url = $this->_options[ 'url2' ];
                break;
            case 'EliminarCIPMod1':
                $url = $this->_options[ 'url2' ];
                break;
            case 'BlackBox':
                $url = $this->_options[ 'url3' ];
                break;
            default:
