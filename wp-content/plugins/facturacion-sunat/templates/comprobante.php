...
require_once(plugin_dir_path( __FILE__ ).'../libs/TCPDF-6.2.13/tcpdf.php');
...
$pdf->image($upload_dir['basedir'].'/logoweb-2.jpg', 1, 1.2, 6, 1.6);

$pdf->SetFont('','',6);
$pdf->setxy(1, 2.6);
$pdf->Cell(8, 0.25, "LOVE IS ALL SOCIEDAD ANONIMA CERRADA - LOVE IS ALL S.A.C.", 0, 1,'L', 0);

$pdf->setxy(1,2.9);
$pdf->Cell(8, 0.25, "CAL.PACARITAMBO NRO. 105 DPTO. 303 (CHACARILLA) LIMA - LIMA - SAN BORJA", 0, 1,'L', 0);
...
$pdf->SetFont('','',14);
$pdf->SetXY(12,1.5);
$pdf->Cell(8, 0.25, "RUC: 20537125684", 0, 1,'C', 0);
...
foreach ($detalle as $item) {
	...
	$pdf->SetXY($X+3.5,$Y+8);
	$pdf->Cell(6.65, 0.8, ($product_name), 1, 1,'L', 0);
